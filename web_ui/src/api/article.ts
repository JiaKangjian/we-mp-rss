 ...
 * 切换文章精选状态
 * @param id 文章ID
 * @param is_featured 精选状态
 * @returns 操作结果
 */
export const toggleArticleFeaturedStatus = (id: number | string, is_featured: boolean) => {
  return http.put<{code: number, message: string, is_featured: boolean}>(`/wx/articles/${id}/featured`, null, {
    params: { is_featured }
  })
}
